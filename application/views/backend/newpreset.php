...
<div class="topnav">
    ...
    <a href="<?php echo base_url()?>Databaseview/presets">View this Database</a>
    <a href="<?php echo base_url()?>Databaseview/logout">Logout</a>
</div>

<div class="container">
    <h3>New Preset Entry</h3>
    <br /><br />
    <form method="post" action="<?php echo base_url()?>Insert/preset_form_validation">
        <?php
        ...
        <div class="form-group">
            <label>Enter Preset Description</label>
