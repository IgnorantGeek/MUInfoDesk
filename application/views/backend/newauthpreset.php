...
<head>
    <meta charset="UTF-8">
    <title>New Authorized Preset Entry</title>
...
<div class="topnav">
    ...
    <a href="<?php echo base_url()?>Databaseview/authorized_presets">View this Database</a>
    <a href="<?php echo base_url()?>Databaseview/logout">Logout</a>
</div>

<div class="container">
    <h3>New Authorized Preset Entry</h3>
    <br /><br />
    <form method="post" action="<?php echo base_url()?>Insert/auth_preset_form_validation">
        <?php
