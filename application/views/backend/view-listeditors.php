...
<head>
    <meta charset="UTF-8">
    <title>Database View List Editors</title>
...
<body>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover">
            ...
            <?php
            if($fetch_list_editors->num_rows() > 0)
            {
                foreach($fetch_list_editors->result() as $row)
                {
            ?>
                <tr>
    ...
    <script>
        $(document).ready(function(){
            $('.delete_data_list_editors').click(function(){
                var id = $(this).attr("id");
                if(confirm("Are you sure you want to delete this?"))
                {
                    window.location="<?php echo base_url();?>Databaseview/delete_data_list_editors/"+id;
                    return true;
                }
                else
                {
